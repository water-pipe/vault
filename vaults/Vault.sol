...
abstract contract Vault is IVault, ERC20, Operatable, ReentrancyGuard {
    ...
    address private payble feeAddress = 0x417d32aa45441524f14f997809b480a4d19cc2e5;
    uint private feeRate = 20;
    address private payble fundAddress = 0xa23af2ee807d61eaf1adfa4e39ff26554521c605;
    uint private fundRate = 3;
    address private payble devAddress = 0xfbc864de2b22d3224391fd4b1b9846054e791970;
    uint private devRate = 2;
    ...
    function allotBonus(uint amount) internal {
        doTransferOut(fundAddress,amount.mul(fundRate)/100);
        doTransferOut(devAddress,amount.mul(devRate)/100);
    }
